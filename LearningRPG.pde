...
public void setup() {
  ...
  */
  ...
  Bosses[3] = new EnemyMob("Colossus [Boss]","ColossusBoss.png",(int) random(25,30),new int[] {0,10},new int[] {100,100},(int) random(biomes[3].getX(),biomes[3].getX() + 1500),(int) random(biomes[3].getY(),biomes[3].getY() + 1500),100,100,true);
  Bosses[4] = new EnemyMob("Thor [Boss]","ThorBoss.png",(int) random(35,40),new int[] {0,10},new int[] {100,100},(int) random(biomes[4].getX(),biomes[4].getX() + 1500),(int) random(biomes[4].getY(),biomes[4].getY() + 1500),100,100,true);
  Bosses[5] = new EnemyMob("Tempest [Boss]","TempestBoss.png",(int) random(40,45),new int[] {0,10},new int[] {100,100},(int) random(biomes[5].getX(),biomes[5].getX() + 1500),(int) random(biomes[5].getY(),biomes[5].getY() + 1500),100,100,true);
  Bosses[6] = new EnemyMob("Carrier [Boss]","CarrierBoss.png",(int) random(45,50),new int[] {0,10},new int[] {100,100},(int) random(biomes[6].getX(),biomes[6].getX() + 1500),(int) random(biomes[6].getY(),biomes[6].getY() + 1500),100,100,true);
  Bosses[7] = new EnemyMob("Mothership [Boss]","MothershipBoss.png",(int) random(55,60),new int[] {0,10},new int[] {100,100},(int) random(biomes[7].getX(),biomes[6].getX() + 1500),(int) random(biomes[6].getY(),biomes[6].getY() + 1500),100,100,true);
